...
if Variable.get("environment") == "development":
    phone_call_details_to_db_args = {"source_": "main_source_0", "sink_": "SDC_sink_0_dev"}
    email_details_to_db_args = {"source_": "main_source_0", "sink_": "SDC_sink_0_dev"}

elif Variable.get("environment") == "production":
    phone_call_details_to_db_args = {"source_": "main_source_0", "sink_": "SDC_sink_0"}
    email_details_to_db_args = {"source_": "main_source_0", "sink_": "SDC_sink_0"}
...
run_phone_call_details_hourly_to_db = PythonOperator(
    task_id='run_phone_call_details_hourly_to_db',
    provide_context=True,
    python_callable=phone_call_details_to_db,
    op_kwargs=phone_call_details_to_db_args,
    dag=dag)

run_email_details_hourly_to_db = PythonOperator(
    task_id='run_email_details_hourly_to_db',
    provide_context=True,
...
(
    run_phone_call_details_hourly_to_db,
    run_email_details_hourly_to_db
